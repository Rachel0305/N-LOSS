# 提取了rx1day rx5day cdd wheat maize都提取了
import numpy as np
import rasterio
...
def save_results(data_dict, profile):
    ...
    for suffix, data in data_dict.items():
        with rasterio.open(f"speiw_Span_{suffix}.tif", 'w', **output_profile) as dst:
            dst.write(data.astype(np.float32), 1)


if __name__ == "__main__":
    NC_FILE = "spei_MON_3_6_12_scale_era5_land_only_0p09_deg_1981_2019.nc"
    PLANT_PATH = "Wheat_plant.tif"
    HARVEST_PATH = "Wheat_harvest.tif"
