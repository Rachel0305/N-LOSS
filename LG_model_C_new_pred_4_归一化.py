...
def predict_global_nitrogen(model_path, input_rasters, mask_raster_path, output_path):
    ...
    if os.path.exists(scaler_path):
        ...
        raise FileNotFoundError(f"未找到归一化文件: {scaler_path}")
    ...
    with rasterio.open(mask_raster_path) as mask_raster:
        ...
        with rasterio.open(output_path, 'w', **profile) as dst:
            ...
            # 使用归一化后的数据进行预测
            output_data[rows, cols] = model.predict(X_normalized)
...
def main():
    ...
    MODEL_PATH = r"D:\CNPK\N_CODE_PY\N_ML_V2\RF_model0810\Wheat\NUE\model.joblib"  # √
    ...
    INPUT_DIR = r"D:\CNPK\N_CODE_PY\N_ML\pred_models\wheat_nh3_predvars_test0810"
    MASK_RASTER_PATH = "Wheat_Harvested_area_2020.tif"
    OUTPUT_PATH = "Wheat_NUE0830.tif"
    # ========================================
